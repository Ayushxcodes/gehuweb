...
/**
 * OrganizePage — 1:1 Next.js App Router TSX replica of MockHostSelectionPage.jsx
 * This page resolves the placeholder issue under /admin/organize in the Sidebar.
